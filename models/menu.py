...
response.menu = [
    (T('Home'), False, URL('default','index'), []), 
            (B('CDR'), False, URL('default', 'cdr'), []), 
            ('Extensions', False, URL('default','extensions'), []),
            (B('Sip'), False, URL('default', 'sql_form'), [
                ('Add Sip User', False, URL('default', 'new_sip_user'))
                ])
...
def _():
    ...
    response.menu+=[
        (SPAN('Menu',_style='color:yellow'),False, 'http://web2py.com', [
                (T('My Sites'),False,URL('admin','default','site')),
                (T('Add Sip User'), False, URL('sip_users','default','new_sip_user')),
